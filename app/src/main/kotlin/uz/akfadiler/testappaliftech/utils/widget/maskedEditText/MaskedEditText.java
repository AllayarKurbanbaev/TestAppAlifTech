package uz.akfadiler.testappaliftech.utils.widget.maskedEditText;
...
//		if (text == null || text.equals("")) return;
    ...
    protected void onSelectionChanged(int selStart, int selEnd) {
        // On Android 4+ this method is being called more than 1 time if there is a hint in the EditText, what moves the cursor toDate left
        // Using the boolean var selectionChanged toDate limit toDate one execution
        ...
        if (initialized) {
            if (!selectionChanged) {
                ...
                //check toDate see if the current selection is outside the already entered text
